...
# cap=cv2.VideoCapture('/home/debosmit2001/Downloads/video.avi')
...
# 	# find out frame rate of video
# 	current_time= time.time()
# 	fps=1/(current_time-prev_time)
# 	prev_time=current_time  #reset the prev_time to current_time
# 	# print(fps)
...
while True:
    ...
    imgRGB = cv2.cvtColor(img, cv2.COLOR_BGR2LAB)
    results = pose.process(imgRGB)
    print(results.pose_landmarks)
    if results.pose_landmarks:
